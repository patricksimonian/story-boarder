...
- **⌂ Home** in the sidebar: flushes any open drafts, lets the boundary commit land, releases the folder, and returns to the dashboard. Everything the app already does at close/switch, pointed at a view instead of a folder.
